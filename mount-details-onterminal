#!/bin/bash
	...
	while [ ${a} -gt  0 ]
      ...
      ## Mount Details On Terminal ##
      echo "Changes detected on mount point ${m_p} it is newly added mount point with current usage of ${used}B out of allocated ${total}B"
	...
	while [ ${d} -gt  0 ]
      ...
      ## Mount Details On Terminal ##
      echo "Changes detected on mount point ${m_p}, it was mounted earlier with usage of ${used}B and total allocated space of ${total}B however it is not mounted now."
